        ...
        <section className="py-8 px-4 content-block">
          <div className="container mx-auto">
            <div className="flex flex-col md:flex-row md:justify-between md:items-start">
              ...
              <div>
                <h2 className="heading-2 text-[#123800] mb-4">
                  Elmvale District Garden Enthusiasts - EDGE
                </h2>
                
                <div className="mb-4">
                  <p className="heading-3 text-[#123800] mb-1">Email: edgeelmvale@gmail.com</p>
                </div>
                
                <div className="mb-6">
                  <p className="heading-3 text-[#123800]">Address: 123 Street Name, Elmvale, ON A1B CD2</p>
                </div>
              </div>
